...
log_path_embeddModel = "./src/llmrag/models/emb_model/checkpoint-5000/trainer_state.json"
log_path_phi2_ft2 = "./src/llmrag/models/gen_model/qa_pairs_finetuning/trainer_state.json"
