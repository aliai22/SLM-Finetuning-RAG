...
from llmrag.training.slm.qa_pairs.finetuning import prepare_peft_model, prepare_peft_trainer
...
from llmrag.training.slm.qa_pairs.helpers import get_max_len, preprocess_dataset, print_number_of_trainable_model_parameters
...
base_llm, tokenizer, eval_tokenizer = load_local_llm(llm_path, base_model_id="microsoft/phi-2")

generate_dataset = False # Change if PDFs are already processed and dataset is created

books_dir = "./data/finetuning/text/AI-books"

file_paths = sorted(glob(f"{books_dir}/*"))
config_file = "./configs/ingest/pdfs_config.json"
data_output_path = "./data/finetuning/text/text_finetuningData.jsonl"
...
training_data_dir = "./runs/text_chunks_ft_checkpoints"
...
# Log file
log_file = ".artifacts/logs/gpu_training_text_ft.csv"
