...
from llmrag.training.slm.qa_pairs.data_processing import dataset_load, dataset_split
from llmrag.training.slm.qa_pairs.helpers import get_max_len, preprocess_dataset, gen
...
dataset = prepare_rag_evaluation_data(file_path=".data/resources/synthetic_QAs.json")
...
ft_model = PeftModel.from_pretrained(base_model,
                                     "./src/llmrag/models/gen_model/text_chunks_finetuning",
...
pred_jsonl = "./outputs/evals/peft_inference_text.jsonl"  # new output location
