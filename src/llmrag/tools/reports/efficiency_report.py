...
from llmrag.training.embedding.embedd_finetuning import load_model as load_embedder
from llmrag.pipelines.ft_2rag.chatbot import rag_chatbot
from llmrag.pipelines.ft_1rag.vectorstore import LocalEmbeddingFunction
...
def main():
    ...
    ap.add_argument("--slm_tokenizer_path", type=str, default=".models/base")
    ap.add_argument("--slm_ft_ckpt", type=str, default=".models/gen_model/qa_pairs_finetuning")
    ap.add_argument("--embed_model_id", type=str, default=".models/emb_model")
    ap.add_argument("--slm_jsonl", type=str, default=".data/finetuning/qa/uniqueQA_dataset0.7.jsonl")
    ap.add_argument("--embed_jsonl", type=str, default=".data/finetuning/qa/uniqueQA_dataset0.7.jsonl")
