...
from .datasets import prepare_rag_evaluation_data
from llmrag.training.embedding.embedd_finetuning import load_model
from tqdm import tqdm
from langchain_community.vectorstores import Chroma
from llmrag.pipelines.ft_2rag.vectorstore import generate_embeddings, LocalEmbeddingFunction, create_vecdb, similarity_score
...
eval_dataset_path = ".data/finetuning/qa/synthetic_QAs.json"
csv_log_path = ".artifacts/logs/rag_eval_results.csv"
